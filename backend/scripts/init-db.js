...
async function init() {
  ...
  const pageData = {
    index: {
      ...
      advantages:advantages: [{ title: '押证不押车，车照开', desc: '抵押车辆登记证（绿本），不装GPS、不押车，不影响日常用车。' }, { title: '多资金并联审批', desc: '长安信托、鑫生金融、长安普惠等多资方并联审批，通过率高、放款快。' }, { title: '全国可办，远程抵押', desc: '支持全国大部分城市办理，部分城市支持远程抵押，足不出户完成放款。' }, { title: '预审0费用', desc: '线上预审完全不收取任何费用，客户经理1对1服务，费用透明。' }],
